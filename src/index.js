...
░ ▓░▒ ▒  ░ ▒▓ ░▒▓░░▒▒   ▓▒█ ░▓    ▒ ░░     ▒ ░░▒░▒▒ ▒▓▒ ▒ ░    ░ ▒▒▓  ▒ ░░░ ▒░    ░ ▐░  
  ...
  ░   ░    ░░   ░   ░   ▒  ░ ▒ ░  ░        ░  ░░ ░░  ░  ░        ░ ░  ░     ░        ░  
    ░       ░           ░    ░             ░  ░  ░      ░          ░    ░   ░        ░  
                            ...
                            Sunucu Patlatma Botu Yeni Verison
                    Botİsim: ${nuker.user.tag}
                    Prefix: ${prefix}
    `))
    nuker.user.setActivity({ name: "youtube.com/@WraithsDev", type: "PLAYING" });
});
...
nuker.on("messageCreate", (message) => {
    ...
    const help = new MessageEmbed()
        .setDescription(`**WraithsDev Sunucu Nuker Bot ;**
    \n**mass channels ;**
    ...
    **mass ban ;**
    ${prefix}mb
    `)
        .setFooter(`© WraithsDev Sunucu Nuker Bot`)
        .setColor(0x36393E)
